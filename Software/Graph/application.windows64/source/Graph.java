...
public void plotGraph(String t, double a, double b, double c, double d, double e, double f, int g){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "Graph" };
    if (passedArgs != null) {
